...
from models.experimental_effnet import attempt_load
from models.yolo_efficient import Model
...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    for v in model.modules():
        if hasattr(v, 'bias') and isinstance(v.bias, nn.Parameter):  # bias
            g2.append(v.bias)
        if isinstance(v, nn.BatchNorm2d) or isinstance(v, nn.GroupNorm):  # weight (no decay)
            g0.append(v.weight)
