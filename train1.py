...
from models.experimental1 import attempt_load
from models.yolo1 import Model
...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    for v in model.modules():
        if hasattr(v, 'bias') and isinstance(v.bias, nn.Parameter):  # bias
            g2.append(v.bias)
        if isinstance(v, nn.BatchNorm2d) or isinstance(v, nn.GroupNorm) or isinstance(v, nn.LayerNorm):  # weight (no decay)
            g0.append(v.weight)
